 ...
 *   </div>
 *
 * All props are optional — defaults match the reactbits.dev defaults exactly.
 */

import { useEffect, useRef } from 'react';
import { Renderer, Program, Mesh, Triangle } from 'ogl';

/* ─── Inline CSS (was Grainient.css) ──────────────────────────────────────── */
const STYLE = `
.grainient-container {
  position: relative;
  width: 100%;
...
function injectStyle() {
  ...
  if (document.getElementById('grainient-style')) return;
  const tag = document.createElement('style');
  tag.id = 'grainient-style';
